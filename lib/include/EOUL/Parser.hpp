...
inline std::ostream& operator<<(std::ostream& os, const EOUL::Parser::ParseResult& result) {
	...
	case ParseResult::ParseUnknownError:

		os << "ParseUnknownError";

		return os;

	case ParseResult::ParseFileStreamNotOpen:

		os << "ParseFileStreamNotOpen";

		return os;

	case ParseResult::ParseSyntaxError:

		os << "ParseSyntaxError";

		return os;

	case ParseResult::ParseSuccessful:

		os << "ParseSuccessful";

		return os;

	case ParseResult::ParseKeyDuplicate:

		os << "ParseKeyDuplicate";
